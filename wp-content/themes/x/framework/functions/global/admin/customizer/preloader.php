...
function x_customizer_preloader() {
  ...
  <div class="x-preloader" id="x-customizer-preloader">
    <div class="x-preloader-logo"><img src="<?php echo get_template_directory_uri().'/framework/img/global/codestar-preload.png' ?>"></div>
    <div class="x-preloader-text"><?php _e( 'Powered by CodeStar', '__x__' ); ?></div>
  </div>
