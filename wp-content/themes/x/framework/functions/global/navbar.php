        ...
        <div class="x-searchform-overlay-inner">
          <div class="x-container max width">
            <form method="get" id="searchform" class="form-search center-text" action="<?php echo esc_url( home_url( '/' ) ); ?>">
              <img src="<?php echo get_template_directory_uri().'/framework/img/global/logo-brick.jpg' ?>">
              <label for="s" class="cfc-h-tx tt-upper"><?php _e( 'Type and Press &ldquo;enter&rdquo; to Search, "ESC" to quit', '__x__' ); ?></label>
